...
public class DBService {
    ...
    public void instanciaDB() {
        Tecnico tec1 = new Tecnico(null, "George Henrique", "655.685.745-96", "georgehenrique233@gmail.com", "123");
        tec1.addPerfil(Perfil.ADMIN);

        Tecnico tec2 = new Tecnico(null, "Leozinho Vitorio", "215.363.114-99", "leozinhovito@gmail.com", "123");
        tec1.addPerfil(Perfil.ADMIN);

        Cliente cli1 = new Cliente(null, "Linus Torvalds", "731.839.816-45", "linustorvalds@hotmail.com", "123");
        Chamado ch1 = new Chamado(null, Prioridade.ALTA, Status.ANDAMENTO, "Chamado 01", "Primeiro Chamado", tec1, cli1);

        Cliente cli2 = new Cliente(null, "Steve Jobs", "969.797.549-39", "stevejobs@protonmail.com", "123");
